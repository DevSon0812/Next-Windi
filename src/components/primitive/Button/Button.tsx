...
const buttonConfig = {
    ...
    soft: {
        primary:
            'bg-primary-50 text-primary-500 border border-primary-50 hover:(bg-primary-500 text-white border-primary-500) disabled:hover:(bg-primary-50 text-primary-500 border-primary-50)',
        secondary:
            'bg-secondary-50 text-secondary-500 border border-secondary-50 hover:(bg-secondary-500 text-white border-secondary-500) disabled:hover:(bg-secondary-50 text-secondary-500 border-secondary-50)',
        info: 'bg-info-50 text-info-500 border border-info-50 hover:(bg-info-500 text-white border-info-500) disabled:hover:(bg-info-50 text-info-500 border-info-50)',
        success:
            'bg-success-50 text-success-500 border border-success-50 hover:(bg-success-500 text-white border-success-500) disabled:hover:(bg-success-50 text-success-500 border-success-50)',
        warning:
            'bg-warning-50 text-warning-500 border border-warning-50 hover:(bg-warning-500 text-white border-warning-500) disabled:hover:(bg-warning-50 text-warning-500 border-warning-50)',
        error: 'bg-error-50 text-error-500 border border-error-50 hover:(bg-error-500 text-white border-error-500) disabled:hover:(bg-error-50 text-error-500 border-error-50)',
    },
    outlined: {
        primary:
    ...
    text: {
        primary:
            'text-primary-500 border border-transparent hover:(bg-primary-50 border-primary-50) disabled:hover:(text-primary-500 border-transparent)',
        secondary:
            'text-secondary-500 border border-transparent hover:(bg-secondary-50 border-secondary-50) disabled:hover:(text-secondary-500 border-transparent)',
        info: 'text-info-500 border border-transparent hover:(bg-info-50 border-info-50) disabled:hover:(text-info-500 border-transparent)',
        success:
            'text-success-500 border border-transparent hover:(bg-success-50 border-success-50) disabled:hover:(text-success-500 border-transparent)',
        warning:
            'text-warning-500 border border-transparent hover:(bg-warning-50 border-warning-50) disabled:hover:(text-warning-500 border-transparent)',
        error: 'text-error-500 border border-transparent hover:(bg-error-50 border-error-50) disabled:hover:(text-error-500 border-transparent)',
    },
} as const;
